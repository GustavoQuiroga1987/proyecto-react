                        ...
                        <tbody>
                            {cart.map(item => (
                                <tr key={item.id}>
                                    ...
                                    <td className="fs-5 fw-bold">{item.nombre}</td>
                                    <td className="fs-4">x{item.quantity}</td>
                                    <td className="text-end fs-5 fw-bold">$ {item.precio}</td>
                                </tr>
                            ))}
                            <tr>
                                <td colSpan={3} className="fs-4 fw-bold"><b>Total</b></td>
                                <td className="text-end fs-4 fw-bold"><b>${getSumProducts()}</b></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
